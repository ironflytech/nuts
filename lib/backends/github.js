...
var GitHub = require('@ironfly/octocat')
...
function GitHubBackend () {
  ...
  var githubOpts = {}
  if (this.opts.token) { githubOpts.token = this.opts.token }
  if (this.opts.endpoint) { githubOpts.endpoint = this.opts.endpoint }
  if (this.opts.username) { githubOpts.username = this.opts.username }
  if (this.opts.password) { githubOpts.password = this.opts.password }
  this.client = new GitHub(githubOpts)
